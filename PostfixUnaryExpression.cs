		...
		public override void VisitPostfixUnaryExpression(PostfixUnaryExpressionSyntax node)
		{
			...
			switch (typeInfo.ConvertedType.SpecialType)
			{
				...
				case SpecialType.System_Decimal:
					...
					break;
				default:
					throw new Exception("PostIncrementExpression/PostDecrementExpression is only supported for sbyte, byte, short, ushort, int, uint, long, ulong, char, float, double, decimal");
			}
