namespace MiniSharpCompiler
{
    ...
    public partial class LLVMIRGenerationVisitor : CSharpSyntaxWalker
    {
        ...
        public LLVMIRGenerationVisitor(SemanticModel model, LLVMModuleRef module, LLVMBuilderRef builder,
            Stack<LLVMValueRef> valueStack)
        {
        ...
        public override void VisitMethodDeclaration(MethodDeclarationSyntax node)
        {
            ...
            this.function = LLVM.AddFunction(this.module, node.Identifier.Text,
                LLVM.FunctionType(returnType.LLVMTypeRef(), out paramTypesArr[0], paramCount, new LLVMBool(0)));
